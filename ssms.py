...
1  Watch 
  Star 1
 Fork 22animator/sendsms
forked from diksha/sendsms
 branch: master  sendsms/sendsms.py
Siddhant Sanyamsiddhant3s on 9 Apr 2011 New script which uses fullonsms as the server. 160 chars. No ending m…
1 contributor
Executable File  243 lines (226 sloc)  9.682 kb RawBlameHistory  
#!/usr/bin/env python
